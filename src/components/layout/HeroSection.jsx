...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-red-600 via-red-700 to-red-900 text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Join our community of life-savers. Register as a blood donor today and help
            us connect with those who need it most.
          </p>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-[#fef2f2] dark:from-gray-900 to-transparent" />
    </section>
  );
}
